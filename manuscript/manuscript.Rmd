...
doi_footer: "Pre-print submitted to *Applied Nursing Research*"
abstract: |
...
2.  Scheduled for an emergency procedure
3.  Unable to understand or speak English and a translator was not immediately available
4.  Nurse in pre-procedure bay considered that there was insufficient time prior to anticipated commencement of the procedure for participation in the study.
...
The R statistical program was used to conduct all analyses [@rcore2020]. All data and R code, along with instructions for how to completely reproduce results of the analyses, is available [here](https://github.com/awconway/ptds).
