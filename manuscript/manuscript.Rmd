---
title: Mokken scale analysis of the perioperative thirst discomfort scale
...
lead_author_surname: Conway et al.

# Place eg a DOI URL or CRAN Package URL here
doi_footer: "Data and statistical code is available [here](https://github.com/awconway/ptds)"

# Abstract
abstract: |
   *Introduction:* Symptoms of thirst discomfort are common in patients who are required to undergo long periods of fasting prior to medical and surgical procedures. The aim of this study was to examine the validity and reliability of the perioperative thirst discomfort scale for measuring thirst discomfort prior to procedures.
   *Methods:* A prospective observational study was conducted. Patients who were fasted and scheduled for an elective cardiac or interventional radiology procedure were included. Mokken scaling analysis was conducted to investigate the unidimensionality and hierarchical nature of the scale. Correlations between perioperative thirst discomfort scale scores and fasting durations were calculated to evaluate construct validity and convergent validity was evaluated by comparing scores with global thirst discomfort and thirst intensity ratings.
   *Results:* 
   *Conclusion:* The items in the PTDS-5 form a strong Mokken scale, meaning it is a reliable and precise way to order patients according to their thirst discomfort. Nurses may use this simple scale to assess the severity of thirst discomfort in patients who are fasted prior to procedures and initiate interventions according to individual needs.
...
The median PTDS-5 score was `r ptds5`. The distribution of PTDS-5 scores was right-skewed (Figure \@ref(fig:distribution)). 

```{r distribution, fig.cap = "Distribution of PTDS-5 scores (higher scores indicate worse thirst discomfort)"}
# knitr::include_graphics("figures/distribution.png")
drake::readd(distribution_plot)
```

There was a positive correlation between PTDS-5 scores and thirst intensity (Figure \@ref(fig:intensity)), as well as the global thirst discomfort rating (Figure \@ref(fig:globalthirst)). The associations between PTDS-5 scores with food and fluid duration is displayed in Figure \@ref(fig:fasting). 
...
```{r globalthirst, fig.cap="Association between PTDS-5 and global thirst rating", eval=params}
# knitr::include_graphics("figures/global-thirst.png")
library(dplyr)
drake::readd(global_thirst_plot)
```

Longer duration of fasting was not linearly associated with PTDS-5 scores. Likewise, the correlation between pain and PTDS-5 scores was not significant (Spearman's rho = `r round(drake::readd(pain_corr)$rho, 2)`; 95% CI = `r round(drake::readd(pain_corr)$CI_low, 2)` to `r round(drake::readd(pain_corr)$CI_high, 2)`).
